...
for sess in sessions:
    for run in runnames:
        ...
        all_parcelTSFilename=sessiondir + run + '_SchaeferAtlas.LR.Parcels.32k_fs_LR.ptseries.nii'
        ...
        os.system('wb_command -cifti-parcellate ' + inputFile + ' ' + schaefer + ' COLUMN ' + all_parcelTSFilename + ' -method MEAN')
