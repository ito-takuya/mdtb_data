...
schaefer=cabnp_dir + '../Schaefer2018_400Parcels_7Networks_order.dlabel.nii'
gordon=cabnp_dir + '../GordonParcels/Parcels_LR.dlabel.nii'
...
for sess in sessions:
    for run in runnames:
        ...
        all_parcelTSFilename=sessiondir + run + '_GordonAtlas.LR.Parcels.32k_fs_LR.ptseries.nii'
        ...
        os.system('wb_command -cifti-parcellate ' + inputFile + ' ' + gordon + ' COLUMN ' + all_parcelTSFilename + ' -method MEAN')
