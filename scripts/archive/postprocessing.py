...
#            rundata = signal.detrend(rundata,axis=0,type='linear')
            ...
            if taskmodel is not None:
                ...
                tasktiming = loadTaskTimingBetaSeries(sess, run, num_timepoints, taskModel=taskmodel)
...
def loadRawParcellatedData(sess,run,datadir='/gpfs/loomis/project/n3/Studies/MurrayLab/taku/mdtb_data/qunex_mdtb/sessions/'):
    """
